...
import ImgMitra2 from "../assets/img-cimb-mitra.png";
import ImgMitra3 from "../assets/img-edelweis.jpeg";
import ImgMitra4 from "../assets/img-ubraw.jpeg";
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="max-w-sm bg-white rounded-lg shadow-sm dark:bg-white-800 dark:border-gray-700 hover:shadow-xl transform hover:-translate-y-0.5">
              <img className="w-full h-40 object-contain rounded-t-lg" src={ImgPro} alt="" />
            ...
            {/* Card 2 */}
            <div className="max-w-sm bg-white rounded-lg shadow-sm dark:bg-white-800 dark:border-gray-700 hover:shadow-xl transform hover:-translate-y-0.5 ">
              <img className="w-full h-40 object-contain rounded-t-lg" src={ImgMitra2} alt="" />
            ...
            <div class="max-w-sm bg-white rounded-lg shadow-sm dark:bg-white-800 dark:border-gray-700 hover:shadow-xl transform hover:-translate-y-0.5">
              <img class="w-full h-40 object-contain rounded-t-lg" src={ImgMitra3} alt="" />
             ...
             <div class="max-w-sm bg-white rounded-lg shadow-sm dark:bg-white-800 dark:border-gray-700 hover:shadow-xl transform hover:-translate-y-0.5">
              <img class="w-full h-40 object-contain rounded-t-lg" src={ImgMitra4} alt="" />
